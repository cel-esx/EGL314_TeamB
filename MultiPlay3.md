...
## The Desired Results
1. Every level has a audio track in the MultiPlay
    eg. Level 1 will play cue 1 play on MultiPlay, level 2 will play cue 2 on MultiPlay
2. If players lose a life, cue 13 will be played, alerting user that they have lost a life.
3. If players lose all 3 lives, cue 14 will be played to indicate that they have lost the game.
4. If players managed to passed the stage(s), cue 12 will be played, alerting players that they have passed the stage.
5. After passing 3 stages, cue 14 will be played for players to know that they have passed onto the next level.
6. Once the next level is played, the POC Code will run the next "current level" audio track. 

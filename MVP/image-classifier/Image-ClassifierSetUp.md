...
8. **Open Data Preparation File**
    ...
    This would be the what you see on screen. <img src="./JupyterSetUpImages/part1a.jpg" width="400" height="400">
...
9. **Open AI Model Training File**
    ...
    e) After running the third code, there should be this input to show your code is working and the AI is learning <img src="./JupyterSetUpImages/part2c.jpg" width="400" height="400">

...
4. **[Penalties](#penalties)**
    * Losing Conditions
5. **[Ready To Play?](#ready-to-play)**
    * Navigate to the Setup Guide to start trainee's journey
...
* **Streamlined Level Progression:** The total length has been consolidated from 4 focused levels down to **3 focused levels**.
* **Stage Restructuring:** Levels 1 and 2 now feature only **1 stages each** while level 3 now feature a shadow gesture gameplay mechanic with 3 stages
* **Preparing Trainees:** With some feedback received, We have implemented a tutorial on how to actually do the hand gesture and the shadow gesture. Trainees need to complete the actual tutorial before engaging in the actual simulation
...
![alt text](<Final Station Pics/IMG 4.jpg>)
